...
class Admin(commands.Cog, name='Admin'):
    ...
    async def invite(self, ctx: SlashContext):
        ...
        embed = discord.Embed(title=STRINGS['general']['botinvitetitle'], colour=discord.Colour(0xff6900),url=f"https://discord.com/api/oauth2/authorize?client_id={bot.client.id}&permissions=204859462&scope=applications.commands%20bot",description=STRINGS['general']['botinvitedesc'])
        embed.set_author(name=STRINGS['general']['botinvitedescd'],url=f"https://discord.com/oauth2/authorize?client_id={bot.client.id}&scope=bot&permissions=204557314")
        embed.add_field(name=STRINGS['general']['botupsdc'], value="https://bots.server-discord.com/",inline=True)
        embed.add_field(name=STRINGS['general']['botuptopgg'], value="https://top.gg/bot/",inline=True)
        embed.add_field(name=STRINGS['general']['botupbod'], value="https://bots.ondiscord.xyz/bots/",inline=True)
        embed.set_footer(text=self.bot.user.name, icon_url=self.bot.user.avatar_url)
        await ctx.send(embed=embed)
