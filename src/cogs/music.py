...
class Music(commands.Cog, wavelink.WavelinkMixin, name="Music"):
    ...
    @commands.command(
        name="leave",
        brief="L.",
        aliases=["fuck_off", "buggerout", "disconnect", "lv", "пшелвон"],
    )
    ...
    async def play_command(self, ctx, *, query: t.Optional[str]):
        ...
        if query is None:
            ...
            if player.queue.is_empty:
                ...
                playEmbed = discord.Embed(
                    title=STRINGS["music"]["playresume"], colour=0xFFD500
                )
                playEmbed.set_footer(text=STRINGS["music"]["embed_controler_footer"])
    ...
    async def play_command_error(self, ctx, exc):
        if isinstance(exc, PlayerIsAlreadyPlaying):
            playEmbed_2 = discord.Embed(
                title=STRINGS["music"]["playererrorone"], colour=0xFFD500
            )
            await ctx.send(embed=playEmbed_2)
    ...
    async def pause_command(self, ctx):
        ...
        pauseEmbed = discord.Embed(
            title=STRINGS["music"]["pausetracktext"], colour=0xFFD500
        )
    ...
    async def pause_command_error(self, ctx, exc):
        if isinstance(exc, PlayerIsAlreadyPaused):
            pauseer_embed = discord.Embed(
                title=STRINGS["music"]["pauseerror"], colour=0xFFD500
            )
    ...
    async def next_command(self, ctx):
        ...
        nextEmbed = discord.Embed(
            title=STRINGS["music"]["skipsongtext"], colour=0xFFD500
        )
    ...
    async def shuffle_command(self, ctx):
        ...
        shuffleEmbed = discord.Embed(
            title=STRINGS["music"]["listshuffled"], colour=0xFFD500
        )
    ...
    async def queue_command(self, ctx):
        ...
        queueEmbed = discord.Embed(
            title=STRINGS["music"]["queuelisttext"], colour=0xFFD500
        )
